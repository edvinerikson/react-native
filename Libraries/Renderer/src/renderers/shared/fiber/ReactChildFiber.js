...
function ChildReconciler(shouldClone, shouldTrackSideEffects) {
  ...
  function updateTextNode(returnFiber: Fiber, current: ?Fiber, textContent: string, priority: PriorityLevel) {
  ...
  function updateElement(returnFiber: Fiber, current: ?Fiber, element: ReactElement<any>, priority: PriorityLevel): Fiber {
  ...
  function updateCoroutine(returnFiber: Fiber, current: ?Fiber, coroutine: ReactCoroutine, priority: PriorityLevel): Fiber {
  ...
  function updateYield(returnFiber: Fiber, current: ?Fiber, yieldNode: ReactYield, priority: PriorityLevel): Fiber {
  ...
  function updateFragment(returnFiber: Fiber, current: ?Fiber, fragment: Iterable<*>, priority: PriorityLevel): Fiber {
  ...
  function createChild(returnFiber: Fiber, newChild: any, priority: PriorityLevel): ?Fiber {
  ...
  function updateSlot(returnFiber: Fiber, oldFiber: ?Fiber, newChild: any, priority: PriorityLevel): ?Fiber {
  ...
  function updateFromMap(existingChildren: Map<string | number, Fiber>, returnFiber: Fiber, newIdx: number, newChild: any, priority: PriorityLevel): ?Fiber {
  ...
  function reconcileChildrenArray(returnFiber: Fiber, currentFirstChild: ?Fiber, newChildren: Array<*>, priority: PriorityLevel): ?Fiber {
  ...
  function reconcileChildrenIterator(returnFiber: Fiber, currentFirstChild: ?Fiber, newChildren: Iterator<*>, priority: PriorityLevel): null {
    // TODO: Copy everything from reconcileChildrenArray but use the iterator
    // instead.
    return null;
  }

  function reconcileSingleTextNode(returnFiber: Fiber, currentFirstChild: ?Fiber, textContent: string, priority: PriorityLevel): Fiber {
  ...
  function reconcileSingleElement(returnFiber: Fiber, currentFirstChild: ?Fiber, element: ReactElement<any>, priority: PriorityLevel): Fiber {
  ...
  function reconcileSingleCoroutine(returnFiber: Fiber, currentFirstChild: ?Fiber, coroutine: ReactCoroutine, priority: PriorityLevel): Fiber {
  ...
  function reconcileSingleYield(returnFiber: Fiber, currentFirstChild: ?Fiber, yieldNode: ReactYield, priority: PriorityLevel): Fiber {
  ...
  function reconcileChildFibers(returnFiber: Fiber, currentFirstChild: ?Fiber, newChild: any, priority: PriorityLevel): ?Fiber {
