...
var ReactCompositeComponent = {
   ...
   * @private
   */
  _checkContextTypes: function (typeSpecs, values, location: ReactPropTypeLocations) {
    if (__DEV__) {
  ...
  _performComponentUpdate: function (nextElement, nextProps, nextState, nextContext, transaction, unmaskedContext) {
    ...
    if (hasComponentDidUpdate) {
      if (__DEV__) {
        transaction.getReactMountReady().enqueue(() => {
          measureLifeCyclePerf(inst.componentDidUpdate.bind(inst, prevProps, prevState, prevContext), this._debugID, 'componentDidUpdate');
        });
      } else {
