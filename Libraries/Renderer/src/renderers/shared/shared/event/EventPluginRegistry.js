 ...
 * @private
 */
function publishEventForPlugin(dispatchConfig: DispatchConfig, pluginModule: PluginModule<AnyNativeEvent>, eventName: string): bool {
...
var EventPluginRegistry = {
   ...
   * @internal
   */
  getPluginModuleForEvent: function (event: ReactSyntheticEvent): null | PluginModule<AnyNativeEvent> {
